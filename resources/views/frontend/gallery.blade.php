...
<section class="photgallery">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-6 col-12" data-aos="zoom-in" data-aos-duration="300" data-aos-delay="200">
        <div data-fancybox data-src="{{ $gallery->thumbnail  }}" data-caption="{{ $gallery->title }}" class="gallerybox" style="cursor: pointer" >
